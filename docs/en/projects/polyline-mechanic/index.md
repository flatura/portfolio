...
2. [Context](02-context-and-problem.md) - enterprise GIS initiative  
3. [Architecture](06-architecture-and-integrations.md) - layered monolithic web application  
4. [Screenshots and Demo](09-roadmap-and-demonstration.md) - UI screenshots  
