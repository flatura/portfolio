...
2. [Problem](02-context-and-problem.md) - operational pain points  
3. [Architecture](06-architecture-and-integrations.md) - monolithic approach, BPMN, C4  
4. [All-in-one](all-in-one.md) - full case study in one page
