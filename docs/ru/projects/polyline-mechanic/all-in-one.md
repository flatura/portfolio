# Утилита редактирования полилиний железнодорожного графа — всё вместе
...
- [Краткое описание](#_2)
- [Обзор](#_8)
- [Контекст и проблема](#_10)
- [Цели, требования и ограничения](#_13)
- [Роль и обязанности](#_17)
- [Модель системы](#_18)
- [Архитектура и интеграции](#_21)
- [Безопасность, качество и эксплуатация](#_27)
- [Решения, компромиссы и риски](#_32)
- [Дорожная карта и демонстрация](#_36)
- [Architecture Decision Records](#architecture-decision-records)

{% include-markdown "./summary.md" heading-offset=1 %}
{% include-markdown "./01-overview.md" heading-offset=1 %}
{% include-markdown "./02-context-and-problem.md" heading-offset=1 %}
