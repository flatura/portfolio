...
2. [Контекст](02-context-and-problem.md) - операционная боль  
3. [Архитектура](06-architecture-and-integrations.md) - многослойный модульный монолит  
4. [Модель данных](05-system-model.md) - диаграмма классов  
