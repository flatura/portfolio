...
2. [Контекст](02-context-and-problem.md) - предпосылки и профиль нагрузки  
3. [Архитектура](06-architecture-and-integrations.md) - проектирование системы  
4. [Всё вместе](all-in-one.md) - полный кейс на одной странице
