...
Да. Для портфолио лучше показать **идею архитектурной модели**, но не раскрывать полный механизм локальной/глобальной видимости культиваров, таблицы доступа, индексы, правила промоции и внутренние workflow.
