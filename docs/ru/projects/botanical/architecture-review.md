# Платформа для ботанических садов (SaaS) — архитектурное ревью
...
- [Модель системы](#_15)
- [Архитектура и интеграции](#_54)
- [Безопасность, качество и эксплуатация](#_58)
- [Решения, компромиссы и риски](#_65)
