...
* **RULE-005. Локальные культивары принадлежат организации-создателю.**
  Культивар, созданный внутри организации, считается локальным и не становится глобально доступным автоматически (только через процедуру регистрации уполномоченным регистратором).
