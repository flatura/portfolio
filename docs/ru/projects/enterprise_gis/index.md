# Корпоративная платформа визуализации данных из внутренних систем
...
2. [Контекст](02-context.md) - внутреннее B2E и B2B-продуктовое направление  
3. [Архитектура](14-architecture.md) - привязка к инфраструктуре, формализация архитектуры  
4. [Ключевые решения](15-key-decisions.md) - изолированная GIS-инфраструктура, конфигурируемая модель данных  
