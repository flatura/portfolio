...
2. [Контекст](02-context-and-problem.md) - внутреннее B2E и B2B-продуктовое направление  
3. [Архитектура](06-architecture-and-integrations.md) - привязка к инфраструктуре, формализация архитектуры  
4. [Ключевые решения](08-decisions-trade-offs-and-risks.md#_2) - изолированная GIS-инфраструктура, конфигурируемая модель данных  
