# Linnata / MyLovelyGarden: мультитенантная SaaS-платформа для ботанических коллекций
...
Linnata — мультитенантная SaaS-платформа для ботанических садов, питомников, селекционеров, научных коллекций и частных собраний растений.
...
Linnata решает эту проблему как единая операционная платформа для живых коллекций растений.
