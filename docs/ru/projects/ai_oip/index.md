...
Enterprise AI-прототип для управленческой аналитики на проверяемых данных - **AI Executive Analyst with verifiable evidence**, который помогает руководителям исследовать бизнес-вопросы без непрозрачного AI-рассуждения.

## Быстрый маршрут

1. [Обзор](01-overview.md) - краткое описание продукта и технологический стек  
2. [Контекст](02-context.md) - продуктовое направление и принцип исполнения  
3. [Архитектура](14-architecture.md) - Tool Gateway, Tool Registry, playbooks  
4. [Скриншоты и демо](20-screenshots-and-demo.md) - demo-сценарии и UI  
