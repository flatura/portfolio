...
architecture-beta
    ...
    service static(aws:simple-storage-servic)[Статика at Amazon S3]
    service storage(aws:simple-storage-servic)[Хранилище файлов at Amazon S3]
    service browser(logos:chrome)[Браузер]
