...
**Статус:** [например, Production / MVP / Архив]  
**Роль:** [например, ведущий архитектор, solo-разработчик]  
**Стек:** [например, Python, AWS Lambda, PostgreSQL]
...
2. [Проблема](03-problem.md) — какую задачу решает проект  
3. [Архитектура](14-architecture.md) — проектирование системы  
4. [Что демонстрирует проект](21-what-this-demonstrates.md) — релевантность для портфолио  
5. [Всё вместе](all-in-one.md) — полный case study на одной странице  

## Документные сборки

- [Всё вместе](all-in-one.md) — все модули для последовательного чтения и экспорта  
